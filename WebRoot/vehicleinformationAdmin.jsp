...
<body bgcolor="#121c27" align="center">
	...
	<div align="center"><a href="queryCardetails?car_no=${item.car_no }"><input type="button" style="background:yellow" value="修改"></a>
	
	<input type="button" style="background:yellow"value="返回"/></div>
		</c:forEach>
