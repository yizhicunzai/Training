			...
			<ul>
				...
				<li>
					<dl class="product_content_dd">
						...
						<dd>
							<a href="parameterM.jsp"><input type=button style="background:yellow" value="了解详情" /></a><a href="" onclick="return login()"
		...
		<div class="product_storyList_content_right">
			<ul>
				...
				<dl class="product_content_dd">
					...
					<dd>
						<a href="parameterM.jsp"><input type=button style="background:yellow" value="了解详情" /></a><font color="yellow"><a href="" onclick="return login()"
								><input type=button style="background:yellow" value="预约" /></a>
					</dd>
